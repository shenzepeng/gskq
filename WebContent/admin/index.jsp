...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr>
    ...
    <td style="background:#fff;">
		<iframe id="MainFrame" name="MainFrame" width="100%" style="margin:0px; padding:0px;" height="100%" scrolling="yes" src="Admin_listAttendTodays.action" frameborder="0"></iframe>
	</td>
    <td width="5"></td>
  </tr>
