...
<title><s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>员工信息</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">员工管理&gt;&gt;<s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>员工</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>员工</TD>
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
          ...
          <td width="65%">
          	<s:if test="#attr.user!=null && #attr.user.user_id!=0"><s:property value="#attr.user.user_no" /></s:if>
          	<s:else><s:textfield name="paramsUser.user_no" id="paramsUser.user_no" value="%{#attr.user.user_no}"/> </s:else>
          </td>
        </tr> 
        <tr>
        ...
        <tr>
          ...
          <td>
              <s:select list="#attr.depts" id="paramsUser.dept.dept_id" name="paramsUser.dept.dept_id" value="%{#attr.user.dept.dept_id}"
		      		listKey="dept_id" listValue="dept_name" headerKey="0" headerValue="请选择" class="selectstyle" cssStyle="width:155px">
		      </s:select>
          </td>
        </tr>   
     </table>
