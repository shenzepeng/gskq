...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            员工编号：
      <input type="text" id="paramsUser.user_no" name="paramsUser.user_no" value="${paramsUser.user_no}" class="inputstyle" style="width:100px"/>&nbsp;
            姓名：
      <input type="text" id="paramsUser.real_name" name="paramsUser.real_name" value="${paramsUser.real_name}" class="inputstyle" style="width:100px"/>&nbsp;
            部门：
      <s:select list="#attr.depts" name="paramsUser.dept_id" value="%{#attr.paramsUser.dept_id}"
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#user.user_no"/></td>
     ...
     <td width="" align="center"><s:property value="#user.dept.dept_name"/>&nbsp;</td>  
